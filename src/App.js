...
function App() {
  ...
  let github = "https://github.com/droppedcalls/cps530-10";
    ...
    <div className="App">
      ...
      <div className="App-body">
        <p>
          ...
          The app was then pushed onto a <a href={github} className='App-link'>GitHub repository</a>, which is then pulled from 
          by <a href={netlify} className='App-link'>Netlify</a> and deployed to the current server.
        </p>
